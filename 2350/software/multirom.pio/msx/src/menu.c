...
char* mapper_description(int number) {
    ...
    int base = (number & 0x3F);
    const char *descriptions[] = {"PL-16", "PL-32", "KonSCC", "Linear", "ASC-08", "ASC-16", "Konami","NEO-8","NEO-16","SYSTEM","SYSTEM","ASC16X","PL-64","MBow2","SYSTEM","SYSTEM"};	
    if (base >= 1 && base <= 16)
